...
namespace WindowsFormsApplication1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class АвторизацияDataTable : global::System.Data.TypedTableBase<АвторизацияRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public АвторизацияRow AddАвторизацияRow(int Id, string Login, string Pass, int role) {
        ...
        public partial class АвторизацияRow : global::System.Data.DataRow {
            ...
            public string Login {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Login\' in table \'Авторизация\' is DBNull.", e);
                    }
                }
                set {
            ...
            public string Pass {
                get {
                    try {
                        return ((string)(this[this.tableАвторизация.PassColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Pass\' in table \'Авторизация\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableАвторизация.PassColumn] = value;
                }
            }
            ...
            public int role {
                get {
                    try {
                        return ((int)(this[this.tableАвторизация.roleColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'role\' in table \'Авторизация\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableАвторизация.roleColumn] = value;
                }
            }
            ...
            public bool IsPassNull() {
                return this.IsNull(this.tableАвторизация.PassColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetPassNull() {
                this[this.tableАвторизация.PassColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsroleNull() {
                return this.IsNull(this.tableАвторизация.roleColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetroleNull() {
                this[this.tableАвторизация.roleColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WindowsFormsApplication1.Database1DataSetTableAdapters {
    ...
    public partial class АвторизацияTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Авторизация] WHERE (([Id] = @Original_Id) AND ((@IsNull_Login = 1 AND [Login] IS NULL) OR ([Login] = @Original_Login)) AND ((@IsNull_Pass = 1 AND [Pass] IS NULL) OR ([Pass] = @Original_Pass)) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Авторизация] ([Id], [Login], [Pass], [role]) VALUES (@Id, @Log" +
                "in, @Pass, @role);\r\nSELECT Id, Login, Pass, role FROM Авторизация WHERE (Id = @I" +
                "d)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Авторизация] SET [Id] = @Id, [Login] = @Login, [Pass] = @Pass, [role] = @role WHERE (([Id] = @Original_Id) AND ((@IsNull_Login = 1 AND [Login] IS NULL) OR ([Login] = @Original_Login)) AND ((@IsNull_Pass = 1 AND [Pass] IS NULL) OR ([Pass] = @Original_Pass)) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)));
SELECT Id, Login, Pass, role FROM Авторизация WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Login, Pass, role FROM dbo.Авторизация";
        ...
        public virtual int Fill(Database1DataSet.АвторизацияDataTable dataTable) {
        ...
        public virtual Database1DataSet.АвторизацияDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.АвторизацияDataTable dataTable = new Database1DataSet.АвторизацияDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.АвторизацияDataTable dataTable) {
        ...
        public virtual int Insert(int Id, string Login, string Pass, global::System.Nullable<int> role) {
        ...
        public virtual int Update(int Id, string Login, string Pass, global::System.Nullable<int> role, int Original_Id, string Original_Login, string Original_Pass, global::System.Nullable<int> Original_role) {
        ...
        public virtual int Update(string Login, string Pass, global::System.Nullable<int> role, int Original_Id, string Original_Login, string Original_Pass, global::System.Nullable<int> Original_role) {
            return this.Update(Original_Id, Login, Pass, role, Original_Id, Original_Login, Original_Pass, Original_role);
        }
    }
